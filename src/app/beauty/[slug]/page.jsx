...
export default function BeautyProductDetailPage() {
  ...
  const handleAddToCart = () => {
    addItem({
      ...
      quantity: quantity,
      variant: { skin_type: product.skin_type }
    });
      ...
      <div style={{ minHeight: '100vh', backgroundColor: '#FFFFFF', paddingBottom: 100 }}>
        ...
        <div style={{ padding: '12px 16px', borderBottom: '1px solid #F3F4F6' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 6, fontSize: 12, color: '#6B7280' }}>
            ...
            <Link href="/beauty" style={{ color: '#6B7280', textDecoration: 'none' }}>Beauty</Link>
          </div>
        </div>
        ...
        <div style={{ padding: '16px' }}>
          ...
          <div style={{ marginTop: 14, display: 'flex', flexDirection: 'column', gap: 6, fontSize: 13 }}>
            ...
            {product.skin_type && <div style={{ color: '#6B7280' }}>Skin Type: <span style={{ color: '#374151', fontWeight: 500 }}>{product.skin_type}</span></div>}
          </div>
          ...
          <div style={{ marginTop: 24, borderTop: '1px solid #F3F4F6' }}>
            ...
            <div style={{ borderBottom: '1px solid #F3F4F6' }}>
              <button onClick={() => setOpenAccordion(openAccordion === 'howtouse' ? '' : 'howtouse')} style={{ width: '100%', padding: '14px 0', display: 'flex', alignItems: 'center', justifyContent: 'space-between', backgroundColor: 'transparent', border: 'none' }}>
                <span style={{ fontSize: 15, fontWeight: 600, color: '#0C0C0C' }}>How to Use</span>
                <ChevronDown size={20} color="#6B7280" style={{ transform: openAccordion === 'howtouse' ? 'rotate(180deg)' : 'none', transition: 'transform 0.2s' }} />
              </button>
                ...
                <div style={{ paddingBottom: 16, fontSize: 13, color: '#4B5563', lineHeight: 1.8 }}>
                  {product.how_to_use || (
                    <ul style={{ margin: 0, paddingLeft: 18 }}>
                      ...
                      <li style={{ marginBottom: 6 }}>Apply gently on face and neck in upward motions</li>
            ...
            <div style={{ borderBottom: '1px solid #F3F4F6' }}>
              ...
              {openAccordion === 'delivery' && (
                <div style={{ paddingBottom: 16, fontSize: 13, color: '#4B5563', lineHeight: 1.8 }}>
                  ...
                  <ul style={{ margin: 0, paddingLeft: 18 }}>
                    <li style={{ marginBottom: 4 }}>7 days easy return for unopened products</li>
                    <li style={{ marginBottom: 4 }}>Product must be in original packaging</li>
                    <li>No return on opened beauty products</li>
                  </ul>
                </div>
              )}
            </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 60, alignItems: 'start' }}>
          ...
          <div style={{ maxWidth: 480 }}>
            ...
            <div style={{ marginTop: 16, display: 'flex', flexDirection: 'column', gap: 6 }}>
              ...
              {product.skin_type && <div style={{ fontSize: 13, color: '#6B7280' }}>Skin Type: <span style={{ color: '#374151', fontWeight: 500 }}>{product.skin_type}</span></div>}
            </div>
            ...
            <div style={{ marginTop: 32, borderTop: '1px solid #F3F4F6' }}>
              ...
              <div style={{ borderBottom: '1px solid #F3F4F6' }}>
                <button onClick={() => setOpenAccordion(openAccordion === 'howtouse' ? '' : 'howtouse')} style={{ width: '100%', padding: '16px 0', display: 'flex', alignItems: 'center', justifyContent: 'space-between', backgroundColor: 'transparent', border: 'none', cursor: 'pointer' }}>
                  <span style={{ fontSize: 15, fontWeight: 600, color: '#0C0C0C' }}>How to Use</span>
                  <ChevronDown size={20} color="#6B7280" style={{ transform: openAccordion === 'howtouse' ? 'rotate(180deg)' : 'none', transition: 'transform 0.2s' }} />
                </button>
                {openAccordion === 'howtouse' && (
