    ...
    <div style={{ minHeight: '100vh', backgroundColor: '#FFFFFF' }}>
      ...
      <div style={{ backgroundColor: '#FFFFFF' }}>
        <div style={{ maxWidth: 1600, margin: '0 auto', padding: '32px 40px' }}>
          <h1 style={{ fontSize: 36, fontWeight: 300, letterSpacing: 6, color: '#0C0C0C', margin: 0, textTransform: 'uppercase' }}>Menswear</h1>
        </div>
      </div>
...
export default function MenswearPage() {
  return (<Suspense fallback={<LoadingFallback />}><MenswearContent /></Suspense>);
}
