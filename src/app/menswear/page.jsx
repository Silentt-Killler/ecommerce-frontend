...
function MenswearContent() {
  ...
  const colorOptions = ['Black', 'White', 'Navy', 'Gray', 'Brown', 'Beige', 'Blue', 'Green', 'Red', 'Maroon'];
  ...
  const fetchSubcategories = async () => {
    try {
      const res = await api.get('/subcategories?parent=menswear');
    ...
    <div style={{ backgroundColor: '#F7F7F7', minHeight: '100vh' }}>
        ...
        <div style={{ maxWidth: 1600, margin: '0 auto', padding: '60px 40px 40px' }}>
          <div style={{ textAlign: 'center', marginBottom: 40 }}>
            ...
            <p style={{ fontSize: 14, color: '#6B7280', letterSpacing: 1 }}>
              Discover our collection of premium men's fashion
            </p>
          </div>
      ...
      <div style={{ maxWidth: 1600, margin: '0 auto', padding: '32px 40px 60px' }}>
        {loading ? (
          ...
          <div style={{ textAlign: 'center', padding: '80px 20px' }}>
            <Shirt size={64} style={{ color: '#D0D0D0', marginBottom: 24 }} />
      ...
      <style jsx global>{`
        ...
        @media (max-width: 1024px) {
          .menswear-grid { grid-template-columns: repeat(3, 1fr) !important; }
        }
        @media (max-width: 768px) {
          .menswear-grid { grid-template-columns: repeat(2, 1fr) !important; }
        }
      `}</style>
    </div>
  );
